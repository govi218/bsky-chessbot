...
def train(
    game: str,
    data_with_board_root_dir=None,
    data_no_board_root_dir=None,
    outdir="models",
    total_steps=10_000,
    batch_size=8,
    max_lr=0.001,
    ...
    if data_with_board_root_dir is None:
        data_with_board_root_dir = f"resources/board_bbox_images/{game}/boards_bbox"
    if data_no_board_root_dir is None:
        data_no_board_root_dir = f"resources/board_bbox_images/{game}/no_boards"
